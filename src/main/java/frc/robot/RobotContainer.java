...
public class RobotContainer {
    ...
    private final Command m_leftPositionCommand =
    new AutonomousDistance(
        m_drivetrainSubsystem);
private final Command m_middlePositionCommand = getAutonomousCommand();
private final Command m_rightPositionCommand = 
new DrivePositionCommand(m_drivetrainSubsystem, 
new Pose2d(5.0, 4.9, m_drivetrainSubsystem.getGyroscopeRotation()));
        ...
        configureButtonBindings();
            ...
            */
            public Command getAutonomousCommand( ){
                ...
                // This can be changed to another command group type like parallel 
                return new SequentialCommandGroup(new PlatformDockPidCommand_Pitch(m_drivetrainSubsystem), m_chooser.getSelected());
            }
